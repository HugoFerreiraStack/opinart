...
import '../components/default_card_support.dart';
              ...
              child: Column(
                ...
                children: [
                  DefaultTextField(
                    ...
                    label: "Assunto",
                    onChanged: (value) {
                      messageController.isBodyValid.value = true;
                    },
                  ...
                  DefaultTextField(
                    ...
                    maxLines: 5,
                    onChanged: (value) {
                      messageController.isSubjectValid.value = true;
                    },
                  ...
                  GetX<MessageController>(builder: (supportController) {
            ...
            children: [
              SizedBox(
                child: Card(
                  ...
                  elevation: 0,
                  child: Padding(
                    padding: EdgeInsets.only(left: 16, right: !Responsive.isMobile(context) ? 48 : 16, top: 16, bottom: 16),
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(
                        ...
                        InkWell(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(color: const Color(0xFF09242E), borderRadius: BorderRadius.circular(8)),
                            child: Row(
